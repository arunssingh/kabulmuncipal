...
public class Pdfviewer_Activity extends BaseActivity {
WebView webview;
ProgressDialog pDialog;
    ...
    public static void setOutput_file(String output_file) {
        Pdfviewer_Activity.output_file = output_file;
    }
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_about_us_pdf);
        ...
        pDialog = new ProgressDialog(Pdfviewer_Activity.this);
       ...
       // webview.loadUrl(url);
        ...
        webview.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                ...
                //Pdfviewer_Activity.this.startActivity(new Intent(Intent.ACTION_VIEW, uri));
                return false;
            }
...
/*
        ...
        tv_detail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MarshMallowPermission permission = new MarshMallowPermission(Pdfviewer_Activity.this);
                ...
                if (permission.checkPermissionForREAD_EXTERNAL_STORAGE()) {
                    ...
                    File f = new File(StaticDataHelper.GetFileName(Pdfviewer_Activity.this, url));
            ...
            for (int i = 0, len = permissions.length; i < len; i++) {
                ...
                if (grantResults[i] == PackageManager.PERMISSION_DENIED) {
                    ...
                    if (showRationale) {
                        ...
                        // the app setting
                        saveToPreferences(Pdfviewer_Activity.this, ALLOW_KEY, true);
                    }
                }
            }
        }
...
public static void saveToPreferences(Context context, String key, Boolean allowed) {
    ...
    private void showAlert() {
        AlertDialog alertDialog = new AlertDialog.Builder(Pdfviewer_Activity.this).create();
        ...
        alertDialog.setButton(AlertDialog.BUTTON_POSITIVE, "ALLOW",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.dismiss();
                        ActivityCompat.requestPermissions(Pdfviewer_Activity.this,
    ...
    private class DownloadFile extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            this.progressDialog = new ProgressDialog(Pdfviewer_Activity.this);
        ...
        protected String doInBackground(String... f_url) {
            ...
            try {
              ...
              //  folder = Environment.getExternalStorageDirectory() + File.separator + "androiddeft/";
                ...
                Pdfviewer_Activity.setOutput_file(outputFile1);
    ...
    private void openFile(File url) {
        ...
        try {
            ...
            Uri uri = FileProvider.getUriForFile(Pdfviewer_Activity.this, BuildConfig.APPLICATION_ID,url);
            ...
            Toast.makeText(Pdfviewer_Activity.this, "No application found which can open the file", Toast.LENGTH_SHORT).show();
        }
    }
